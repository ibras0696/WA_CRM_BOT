...
FULL_HELP_TEXT = (
    ...
    "• удаление сделок и отчёты за период\n\n"
    "👷 *Меню сотрудника* — отправьте `1`:\n"
    "• открытие смены и установка стартового лимита\n"
    "• создание сделок (сумма может быть `+` или `-`)\n"
    "• просмотр текущего лимита и последних сделок\n\n"
